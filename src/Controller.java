...
//            appendToCSV(out1, "fetch_usatoday.csv");
//            appendToCSV(out2, "visit_usatoday.csv");
//            appendToCSV(out3, "urls_usatoday.csv");
        }

        writeCSV(out1, "fetch_usatoday.csv");
        writeCSV(out2, "visit_usatoday.csv");
        writeCSV(out3, "urls_usatoday.csv");
    ...
    private static void appendToCSV(StringBuilder output, String fileName) throws IOException {
        try (FileWriter writer = new FileWriter(fileName, true)) {
            writer.append(output.toString().trim());
            writer.append("\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
